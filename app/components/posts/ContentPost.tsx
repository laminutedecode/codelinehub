    ...
    <div className="max-w-[1200px] mx-auto md:border-l md:border-r px-6 pb-6">
        <div className="flex items-center justify-between pt-6 mb-4">
          ...
          <p className="text-sm flex items-center justify-end gap-2  text-gray-300">
            <GrUpdate />
            <span>Mise à jour le {formatDate(postData.updatedAt)}</span>
          </p>
        </div>
      ...
      <Link target="_blank" href={postData?.postUrl} className="inline-flex items-center ml-auto  gap-2  bg-purple-800 hover:bg-purple-500 px-3 py-1.5 text-white my-3 rounded-md">Voir le projet</Link>
